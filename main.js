...
(() => {
  ...
  const projectCatalog = [
    ...
    
    {
      ...
      hero: "/assets/images/bearingHub.jfif",
    ...
    },
    {
      ...
      hero: "/assets/images/ikea lamp.jfif",
    ...
    
    {
      ...
      solution: "I connected an Arduino sonar unit to a Python GUI over serial, enabling a clear real-time display for testing and presentation. Check out the repo here: https://github.com/mcneds/arduino-radar",
    ...
    },
    {
      ...
      solution: "I rebuilt an earlier high-school concept into a web tool that supports keys, files, or passphrases for extraction workflows. Take a look at the repo here: https://github.com/mcneds/steganography",
    ...
    },
    {
      ...
      solution: "I created a heuristic-based visual generator for whole-number triangles to speed design in systems like Lego Technic and Minecraft grids. Take a look here: https://github.com/mcneds/Trigen",
    ...
    },
    {
      ...
      hero: "/assets/images/albumgen.png",
      ...
      solution: "I built a pipeline that pulls Spotify API data and formats posters with CSS-driven layouts for quick design iteration. Try it here: https://mcneds.github.io/Album-Poster-Generator/",
    ...
    },
    {
      ...
      solution: "I simulated player jump constraints in sampled environments and used that state to generate procedural platforming paths in an efficient way. The resulting algorithm produced more interesting routes that respected jump feasibility and engagement considerations. An implementation of this algorithm can be found here: https://kuemmerle.dev/fun/voxel-parkour/",
    ...
    
    {
      ...
      hero: "/assets/images/Elliptical%20Arch%20Bridge/project pictures/final/finished photos/hero.jpg",
    ...
    },
    {
      ...
      hero: "/assets/images/drinkBot/drinkBot Wiring Diagram.png",
    ...
    },
    {
      ...
      hero: "/assets/images/dorm maker setup.jpg",
      alt: "Parametric desk model for plywood and dimensional lumber builds",
      problem: "Small and effective space usage desk for dorm was needed but available solutions were not a great fit for the space or were prohibitively expensive.",
      solution: "I built a parameter-driven desk model so dimensions can be regenerated quickly for different spaces while preserving structural logic; then I fabricated the design and organized things for an affordable and customizable workspace.",
    ...
    
    {
      ...
      problem: "High-RPM drift use exposed weaknesses in stock hub durability and overall suspension tuning. It also necessitated a custom  hub solution that would perform under the high rpm and torque conditions.",
    ...
    },
    {
      ...
      hero: "/assets/images/crawler.png",
